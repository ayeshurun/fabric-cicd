...
def test_orgappaudience_folder_regex_root_orgapp():
    ...
    relative_path = "/SampleApp.OrgApp/.children/AllUsers.OrgAppAudience"
    match = pattern.match(relative_path)
...
def test_orgappaudience_folder_regex_nested_subfolder():
    ...
    pattern = re.compile(constants.ORG_APP_AUDIENCE_FOLDER_PATH_REGEX)
    relative_path = "/subfolder/AppName.OrgApp/.children/Audience.OrgAppAudience"
    match = pattern.match(relative_path)
...
def test_orgappaudience_folder_regex_no_match_edge_case():
    ...
    pattern = re.compile(constants.ORG_APP_AUDIENCE_FOLDER_PATH_REGEX)
    bad_paths = [
        "/SomeFolder/Audience.OrgAppAudience",  # no OrgApp container
        "/Another.OrgApp/Audience.OrgAppAudience",  # missing '.children'
        "/prefix/.children/Audience.OrgAppAudience",  # missing OrgApp segment
    ]
    for p in bad_paths:
        assert pattern.match(p) is None, f"Regex should not match path: {p}"
